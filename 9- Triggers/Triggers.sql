...
/*
     ...
     employees. Al activarse, debe insertar un registro en una tabla de auditoría 
     llamada auditoria_area, almacenando el nombre de la area insertado, el usuario que realizó la acción, y la fecha de la operación.
*/
